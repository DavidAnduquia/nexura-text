...
export default function Create({ auth, areas, roles }) {
        ...
        >
            ...
            <div className="p-6">
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <div className="mt-2 space-x-4">
                            <label className="inline-flex items-center">
                                <input type="radio" name="sexo" value="M" onChange={(e) => setData('sexo', e.target.value)} className="text-blue-600 focus:ring-blue-500" />
                                <span className="ml-2 text-gray-700 dark:text-gray-300">Masculino</span>
                            </label>
                            <label className="inline-flex items-center">
                                <input type="radio" name="sexo" value="F" onChange={(e) => setData('sexo', e.target.value)} className="text-blue-600 focus:ring-blue-500" />
                    ...
                    <div>
                        <label className="inline-flex items-center">
                            <input type="checkbox" value="1" onChange={(e) => setData('boletin', e.target.checked ? 1 : 0)} className="rounded text-blue-600 focus:ring-blue-500" />
                        ...
                        <div className="mt-2 space-y-2">
                            {roles.map(rol => (
                                <label key={rol.id} className="flex items-center">
                                    <input type="checkbox" value={rol.id} onChange={handleRoleChange} className="rounded text-blue-600 focus:ring-blue-500" />
